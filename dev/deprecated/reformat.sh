...
#SBATCH --output=slurm-reformat-%j.out

# ==============================================================================
#                          CONSTANTS AND DEFAULTS
# ==============================================================================
# Constants - generic
DESCRIPTION="Generic script to run BBmap's reformat.sh, e.g. to filter by GC content"
SCRIPT_VERSION="2023-12-02"
...
script_help() {
    ...
    echo "  - Basic usage:"
    echo "      sbatch $0 -i data/A_R1.fastq.gz -o results/reformat --more_opts 'mingc=0.6'"
    echo
...
# Define outputs etc based on script parameters
...
[[ "$indir" == "$outdir" ]] && die "Input dir can't be the same as the output dir (both are $indir)"
