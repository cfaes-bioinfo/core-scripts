...
#SBATCH --output=slurm-chopper-%j.out

# ==============================================================================
#                          CONSTANTS AND DEFAULTS
# ==============================================================================
# Constants - generic
DESCRIPTION="Run Chopper to filter and/or trim ONT reads"
...
TOOL_BINARY=chopper
TOOL_NAME=Chopper
TOOL_DOCS=https://github.com/wdecoster/chopper
VERSION_COMMAND="$TOOL_BINARY --version"

# Defaults - generics
env_type=conda                           # Use a 'conda' env or a Singularity 'container'
conda_path=/fs/ess/PAS0471/jelmer/conda/chopper
container_path=
container_url=
dl_container=false
...
script_help() {
    ...
    echo "  - Basic usage:"
    echo "      sbatch $0 -i my.fastq -o results/chopper/trimmed.fastq"
    echo
...
[[ "$infile" == "$outfile" ]] && die "Input and output file paths are the same ($infile)"
