...
#SBATCH --job-name=dorado_trim
#SBATCH --output=slurm-dorado_trim-%j.out

# ==============================================================================
#                          CONSTANTS AND DEFAULTS
# ==============================================================================
# Constants - generic
DESCRIPTION="Use Dorado to trim primer and adapter sequences from ONT reads"
SCRIPT_VERSION="2024-09-25"
SCRIPT_AUTHOR="Jelmer Poelstra"
REPO_URL=https://github.com/mcic-osu/mcic-scripts
FUNCTION_SCRIPT_URL=https://raw.githubusercontent.com/mcic-osu/mcic-scripts/main/dev/bash_functions.sh
TOOL_BINARY="dorado trim"
TOOL_NAME=Dorado
...
script_help() {
    ...
    echo "  -i/--infile         <file>  Input file in FASTQ or BAM format"
...
outfile="$outdir"/$(basename "${infile%%.*}").$out_format
...
if [[ "$out_format" == "fastq" ]]; then
    log_time "Gzipping the output FASTQ file..."
    gzip -v "$outfile"
fi
