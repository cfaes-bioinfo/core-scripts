...
#SBATCH --job-name=fast5topod5
#SBATCH --output=slurm-fast5topod5-%j.out

# ==============================================================================
#                          CONSTANTS AND DEFAULTS
# ==============================================================================
# Constants - generic
DESCRIPTION="Convert ONT FAST5 files to POD5 files using 'pod5 convert'"
...
TOOL_BINARY=pod5
TOOL_NAME=pod5
TOOL_DOCS=https://github.com/nanoporetech/pod5-file-format/blob/master/python/pod5/README.md#pod5-convert-fast5
VERSION_COMMAND="$TOOL_BINARY --version"

# Defaults - generics
env_type=conda                           # Use a 'conda' env or a Singularity 'container'
conda_path=/fs/ess/PAS0471/jelmer/conda/pod5
container_path=
container_url=
dl_container=false
...
script_help() {
    ...
    echo "  - Basic usage:"
    echo "      sbatch $0 -i data/fast5 -o data/pod5"
    echo
    echo "REQUIRED OPTIONS:"
    echo "  -i/--indir          <file>  Input dir with FAST5 files"
...
[[ ! -f "$indir" ]] && die "Input dir $indir does not exist"
