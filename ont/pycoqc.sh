...
conda_path=
container_url=oras://community.wave.seqera.io/library/pycoqc:2.5.2--ae91501c756a19e6
...
USAGE / EXAMPLE COMMANDS:
    - Basic usage example:
            sbatch $0 -i data/sequencing_summary.txt -o results/pycoqc
    - Mark only reads with Phred quality >= 10 as PASS:
            sbatch $0 -i data/sequencing_summary.txt -o results/pycoqc --min_qual 10
    - Mark only reads with length >= 1000 as PASS:
            sbatch $0 -i data/sequencing_summary.txt -o results/pycoqc --min_len 1000
    
REQUIRED OPTIONS:
    -i/--infile         <file>  Input file: a sequencing summary text file
    -o/--outdir         <dir>   Output dir (will be created if needed)
    
OTHER KEY OPTIONS:
    --min_qual          <int>   Min. Phred read quality score to PASS
    --min_len           <int>   Min. read length to PASS
