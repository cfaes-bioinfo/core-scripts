...
#SBATCH --job-name=dl-blastdb
#SBATCH --output=slurm-dl-blastdb-%j.out
...
USAGE / EXAMPLE COMMANDS:
    - Basic usage example:
            sbatch $0 --db nt -o results/blastdb

REQUIRED OPTIONS:
    --db                <str>   NCBI BLAST database to download
                                Possible options include: nr, nt, core_nt, nt_euk,
                                nt_viruses, swissprot, taxdb, mito
                                Run 'update_blastdb.pl --showall' to see all options
    -o/--outdir         <dir>   Output dir for BLAST database
