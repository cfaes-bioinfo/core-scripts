...
# ==============================================================================
# Constants - generic
DESCRIPTION="Run InterProScan to functionally annotate a genome (proteome)"
SCRIPT_VERSION="2025-09-14"
SCRIPT_AUTHOR="Jelmer Poelstra"
REPO_URL=https://github.com/mcic-osu/mcic-scripts
FUNCTION_SCRIPT_URL=https://raw.githubusercontent.com/mcic-osu/mcic-scripts/main/dev/bash_functions.sh
TOOL_BINARY=interproscan.sh
TOOL_NAME=InterProScan
TOOL_DOCS=https://interproscan-docs.readthedocs.io
VERSION_COMMAND="$TOOL_BINARY --version"

# Defaults - generics
env_type=conda                  # Use a 'conda' env or a Singularity 'container'
conda_path=/fs/ess/PAS0471/conda/interproscan_5.75
container_url=
...
USAGE / EXAMPLE COMMANDS:
  - Basic usage example:
      sbatch $0 -i proteins.faa -o results/interproscan
...
HARDCODED INTERPROSCAN OPTIONS THAT THE SCRIPT WILL ALWAYS RUN:
  --goterms                  Retrieve Gene Ontology (GO) terms
  --pathways                 Retrieve pathway annotations (e.g. KEGG, MetaCyc)
  --iprlookup                Include InterPro annotations
  --disable-precalc          Run everything offline
...
# ==============================================================================
#                      INSTALLATION NOTES (2025-09-15)
# ==============================================================================
## - Installation - https://interproscan-docs.readthedocs.io/en/v5/HowToDownload.html
# wget -P software/interproscan https://ftp.ebi.ac.uk/pub/software/unix/iprscan/5/5.75-106.0/interproscan-5.75-106.0-64-bit.tar.gz
# cd software/interproscan
# tar -pxvzf interproscan-5.75-106.0-*-bit.tar.gz
## - Create a Conda env for it:
# micromamba env create -p /fs/ess/PAS0471/conda/interproscan_5.75
# mkdir -p /fs/ess/PAS0471/conda/interproscan_5.75/bin
# cp -r software/interproscan/interproscan-5.75-106.0/* /fs/ess/PAS0471/conda/interproscan_5.75/bin/
